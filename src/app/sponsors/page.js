    ...
    <>
      ...
      >
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <div className="absolute w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-[var(--primary-green)] rounded-full blur-[50px] md:blur-[100px] -top-10 -left-10 md:-top-20 md:-left-20" />
          <div className="absolute w-[150px] h-[150px] md:w-[300px] md:h-[300px] bg-[var(--accent-yellow)] rounded-full blur-[40px] md:blur-[80px] -bottom-5 -right-5 md:-bottom-10 md:-right-10" />
        </div>
      </HeroSection>
      <DynamicContent />
    </>
